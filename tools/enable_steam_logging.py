...
Sets -consolelog in Steam's localconfig.vdf so all [ROULETTE] logs stream directly
to E:\SteamLibrary\steamapps\common\Deadlock\game\citadel\console.log.
"""
...
echo ===================================================
echo Launching Deadlock with -consolelog...
start "" "{str(steam_exe)}" -applaunch 1422450 -consolelog
...
def main():
    print("=== ENABLING STEAM DEADLOCK CONSOLE LOGGING ===")
